    ...
    if tab is not None:
        try:
            ...
            if success:
                ...
                tab1.ele('xpath://*[@id="id_container"]/div[1]/div[1]/div[3]/div/div[2]/div[2]').click()
                time.sleep(3)
                tab1.ele('xpath://*[@id="id_container"]/div[3]/div[1]/div[3]').click()
                time.sleep(3)
                ...
                tab1.ele('xpath://*[@id="id_container"]/div[1]/div[1]/div[3]/div/div[2]/div[2]').click()
                time.sleep(3)
                tab1.ele('xpath://*[@id="id_container"]/div[3]/div[1]/div[2]').click()
                time.sleep(3)
                tab1.ele('xpath://*[@id="id_container"]/div[3]/div[1]/div[3]').click()
                time.sleep(3)
