...
def main():
    ...
    try:
        ...
        time.sleep(2)
        logger.info("用户名密码输入成功")
    except Exception as e:
        logger.error(f"用户名密码输入失败: {e}")
        raise
    ...
    try:
        ...
        time.sleep(2)
        logger.info("运管2.0平台登录信息输入成功")
    except Exception as e:
        logger.error(f"运管2.0平台登录信息输入失败: {e}")
        raise

    logger.info("运管2.0平台获取短信验证码...")
    try:
        ...
        time.sleep(3)
        logger.info("运管2.0平台短信验证码处理成功")
    except Exception as e:
        logger.error(f"运管2.0平台短信验证码处理失败: {e}")
        raise

    # 数字人运营管理平台 - 创建另一个新标签页
    logger.info("创建新标签页，导航到数字人运营管理平台...")
    try:
